...
def consul_for_life_vote_bonus_message(
    voting_senators: Iterable[Senator], proposal: Optional[str]
) -> str:
    """Describe the influence the nominee added to his own vote total (1.09.821).
