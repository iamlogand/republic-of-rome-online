...
def create_senator_notifications(apps, schema_editor):
    ...
    for notification in notifications:
        ...
        senator_keys = [
            key for key in notification.data.keys() if key.endswith("senator")
        ]
        ...
        for senator_key in senator_keys:
            ...
            if senator_id:
                ...
                SenatorNotification.objects.create(
                    senator=senator, notification=notification
                )
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="rorapp.notification",
                    ),
                ),
                (
                    "senator",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="rorapp.senator"
                    ),
                ),
            ],
        ),
