...
def test_land_bill_type_i_pass_reduces_unrest(senate_game: Game, resolver: FakeRandomResolver):
    # Arrange
    game = senate_game
    game.unrest = 3
    game.save()
...
@pytest.mark.django_db
def test_land_bill_type_ii_pass_reduces_unrest_by_2(senate_game: Game, resolver: FakeRandomResolver):
    # Arrange
    game = senate_game
    game.unrest = 5
    game.save()
...
@pytest.mark.django_db
def test_land_bill_type_iii_pass_reduces_unrest_by_3(senate_game: Game, resolver: FakeRandomResolver):
    # Arrange
    game = senate_game
    game.unrest = 5
    game.save()
...
@pytest.mark.django_db
def test_land_bill_pass_places_effect_marker(senate_game: Game, resolver: FakeRandomResolver):
    # Arrange
    game = senate_game
    _setup_land_bill_vote(game, "II", 15, 0)
...
@pytest.mark.django_db
def test_land_bill_pass_increases_sponsor_popularity(senate_game: Game, resolver: FakeRandomResolver):
    # Arrange
    game = senate_game
...
@pytest.mark.django_db
def test_land_bill_pass_increases_cosponsor_popularity(senate_game: Game, resolver: FakeRandomResolver):
    # Arrange
    game = senate_game
...
@pytest.mark.django_db
def test_land_bill_pass_type_iii_sponsor_popularity(senate_game: Game, resolver: FakeRandomResolver):
    # Arrange
    game = senate_game
...
@pytest.mark.django_db
def test_land_bill_pass_voted_nay_reduces_popularity(senate_game: Game, resolver: FakeRandomResolver):
    # Arrange
    game = senate_game
    senators = list(Senator.objects.filter(game=game, alive=True))
    sponsor = senators[0]
...
@pytest.mark.django_db
def test_land_bill_pass_blocks_same_type_reproposal(senate_game: Game, resolver: FakeRandomResolver):
    # Arrange
    game = senate_game
    _setup_land_bill_vote(game, "II", 15, 0)
...
@pytest.mark.django_db
def test_land_bill_fail_blocks_same_type_reproposal(senate_game: Game, resolver: FakeRandomResolver):
    # Arrange
    game = senate_game
...
@pytest.mark.django_db
def test_land_bill_fail_does_not_place_effect_marker(senate_game: Game, resolver: FakeRandomResolver):
    # Arrange
    game = senate_game
...
@pytest.mark.django_db
def test_land_bill_type_i_unrest_capped_at_zero(senate_game: Game, resolver: FakeRandomResolver):
    # Arrange
    game = senate_game
    game.unrest = 0
    game.save()
