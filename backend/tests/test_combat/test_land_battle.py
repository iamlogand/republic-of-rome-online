...
@pytest.mark.django_db
def test_land_battle_victory_2_losses(land_campaign: Campaign):
...
@pytest.mark.django_db
def test_land_battle_stalemate_2_losses(land_campaign: Campaign):
...
@pytest.mark.django_db
def test_land_battle_defeat_1_loss(land_campaign: Campaign):
...
@pytest.mark.django_db
def test_land_battle_defeat_5_losses(land_campaign: Campaign):
