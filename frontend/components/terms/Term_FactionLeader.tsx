...
const FactionLeaderTerm = () => (
  ...
  >
    <p>
      ...
      <TermLink name="Faction" displayName="Faction's" /> Members. Faction
      Leaders are immune from Persuasion Attempts, making their{" "}
    ...
    <p>
      ...
      <TermLink name="Military" />, <TermLink name="Oratory" /> and Loyalty, but
      not his Influence, Talents, Popularity or Knights.
    </p>
  </TermLayout>
)
