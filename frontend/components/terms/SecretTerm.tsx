...
const SecretTerm = () => (
  ...
  >
    <p>
      A <b>Secret</b> is a hidden item belonging to a{" "}
    ...
    <ul className="mt-0 flex flex-col gap-4">
      <li>
        ...
        during the <TermLink name="Faction Phase" /> or the{" "}
        <TermLink name="Revolution Phase" /> to immediately bring the named{" "}
        <TermLink name="Statesman" /> into the game.
      </li>
      <li>
        <span className="font-bold">Concession Secrets</span> can be revealed
        during the Faction Phase or the Revolution Phase to grant a{" "}
        <TermLink name="Concession" /> to a chosen Faction member.
      </li>
      <li>
