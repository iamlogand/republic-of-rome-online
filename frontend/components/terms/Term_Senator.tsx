...
const SenatorTerm = () => (
  ...
  >
    ...
    <p>
      ...
      <TermLink name="Faction" />. Unaligned Senators will always Abstain from
      Voting and can&apos;t be assigned an Office.
    </p>
    <p>
    ...
    <p>
      Most Senators are Family Senators, who are identified by their Family name
      (e.g. “Cornelius”). Each living Family Senator is the current leader of
      their Family. When a Family Senator dies, their Heir may return later as
      an Unaligned Senator.
    </p>
    <h5 className="mt-3 font-bold">Statesmen</h5>
    <p>
      A Statesman is a special type of Senator—a famous historical figure with a
      unique ability. They are identified by their full names (e.g. “P.
      Cornelius Scipio Africanus”). Statesmen can only appear when a Faction
      reveals a Statesman <TermLink name="Secret" />.
    </p>
    <p>
      Statesmen are always Aligned to a Faction, but they are still vulnerable
      to Persuasion Attempts. When they die, they never return.
    </p>
  </TermLayout>
)
