...
import styles from "./SenatorPortrait2.module.css"
...
const SenatorPortrait2 = (props: SenatorPortraitProps) => {

  const getImageContainerStyle = () => {
    return {
      border: '2px solid' + props.senator.getColor("primary", props.faction.position),
      height: 72, width: 72
    }
  }
  ...
  const getBgStyle = () => {
    ...
    let bgColor = props.senator.getColor("bg", props.faction.position)
...
export default SenatorPortrait2;