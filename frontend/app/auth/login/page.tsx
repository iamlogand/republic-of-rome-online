          ...
          {loading ? (
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="my-2 flex flex-col gap-4 rounded bg-neutral-100 px-8 py-6 text-sm">
                ...
                <ul className="flex list-disc flex-col gap-2 pl-8">
                  <li>
                    Your first name is used to generate your initial username,
                    but you can change it at any time. Your username is only
                    visible to other players if you host or join a game.
                  </li>
                  <li>
                    Your email address is not shared with other players.
                    However, it may be used to contact you regarding gameplay
                    issues, to request feedback, or to inform you about updates
                    and changes to the project.
                  </li>
                  <li>
                    Your profile picture may be used in the future to
                    personalize your account and display your identity to other
                    players during the game. This feature will be opt-in and
                ...
                <p>
                  ...
                  parties. Since this is an open-source project, transparency
                  and community trust are priorities. If you have any concerns,
                  feel free to reach out or review the codebase on{" "}
                  <a
